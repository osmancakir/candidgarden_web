...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'Candid Garden email changed',
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Candid Garden · email change</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Candid Garden email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Candid Garden email has been
						changed.
					</E.Text>
				</p>
				<p>
