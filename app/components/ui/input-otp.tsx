...
const InputOTPSlot = ({
	...
	return (
		<div
			...
			className={cn(
				'border-rule-strong font-data text-data-lg relative flex size-11 items-center justify-center border-y border-r tabular-nums transition-colors first:border-l',
